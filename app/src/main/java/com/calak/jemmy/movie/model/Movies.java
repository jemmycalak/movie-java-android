...
public class Movies implements Serializable {
    ...
    public Movies(int id, String title, String original_language, String original_title, String overview, double popularity, String poster_path, String release_date, double vote_average, int vote_count) {
        this.id = id;
        this.title = title;
